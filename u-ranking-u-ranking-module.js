(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["u-ranking-u-ranking-module"],{

/***/ "./src/app/usuario/u-ranking/u-ranking.module.ts":
/*!*******************************************************!*\
  !*** ./src/app/usuario/u-ranking/u-ranking.module.ts ***!
  \*******************************************************/
/*! exports provided: URankingPageModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "URankingPageModule", function() { return URankingPageModule; });
...
/* harmony import */ var _u_ranking_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./u-ranking.page */ "./src/app/usuario/u-ranking/u-ranking.page.ts");
...
var routes = [
    {
        path: '',
        component: _u_ranking_page__WEBPACK_IMPORTED_MODULE_5__["URankingPage"]
    }
];
var URankingPageModule = /** @class */ (function () {
    function URankingPageModule() {
    }
    URankingPageModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [_u_ranking_page__WEBPACK_IMPORTED_MODULE_5__["URankingPage"]]
        })
    ], URankingPageModule);
    return URankingPageModule;
}());
...
/***/ "./src/app/usuario/u-ranking/u-ranking.page.html":
/*!*******************************************************!*\
  !*** ./src/app/usuario/u-ranking/u-ranking.page.html ***!
  \*******************************************************/
...
/***/ "./src/app/usuario/u-ranking/u-ranking.page.scss":
/*!*******************************************************!*\
  !*** ./src/app/usuario/u-ranking/u-ranking.page.scss ***!
  \*******************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3VzdWFyaW8vdS1yYW5raW5nL3UtcmFua2luZy5wYWdlLnNjc3MifQ== */"

/***/ }),

/***/ "./src/app/usuario/u-ranking/u-ranking.page.ts":
/*!*****************************************************!*\
  !*** ./src/app/usuario/u-ranking/u-ranking.page.ts ***!
  \*****************************************************/
/*! exports provided: URankingPage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "URankingPage", function() { return URankingPage; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var URankingPage = /** @class */ (function () {
    function URankingPage(route, loading, cloud, sanatizer) {
        this.route = route;
        this.loading = loading;
        this.cloud = cloud;
        this.sanatizer = sanatizer;
        this.listadoRanking = []; //lista de usuarios del ranking
        this.urlFirst = null; //url del avatar del primero
        this.urlSecond = null; //url del avatar del segundo
        this.urlThird = null; //url del avatar del tercero
    }
    URankingPage.prototype.ngOnInit = function () {
    ...
    URankingPage.prototype.ionViewWillEnter = function () {
     ...
     */
    URankingPage.prototype.updateRanking = function (event, reload) {
        var _this = this;
        if (!event)
            this.loading.show(""); //si es carga por visita activamos loading principal
        this.cloud.getRanking(reload).then(function (d) {
            if (reload) {
                _this.listadoRanking = d; //carga completa
            }
            else {
                d.forEach(function (u) {
                    _this.listadoRanking.push(u); //añadimos al final
                });
            }
            if (!event)
                _this.loading.hide();
    ...
    URankingPage.prototype.getImagen = function (img) {
    ...
    ], URankingPage.prototype, "ionInfiniteScroll", void 0);
    URankingPage = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-u-ranking',
            template: __webpack_require__(/*! ./u-ranking.page.html */ "./src/app/usuario/u-ranking/u-ranking.page.html"),
            styles: [__webpack_require__(/*! ./u-ranking.page.scss */ "./src/app/usuario/u-ranking/u-ranking.page.scss")]
        }),
...
//# sourceMappingURL=u-ranking-u-ranking-module.js.map